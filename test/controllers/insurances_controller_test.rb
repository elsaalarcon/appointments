...
class InsurancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insurance" do
    assert_difference('Insurance.count') do
      post insurances_url, params: { insurance: { name: @insurance.name, number: @insurance.number, phone: @insurance.phone, user_id: @insurance.user_id } }
    end
  ...
  test "should update insurance" do
    patch insurance_url(@insurance), params: { insurance: { name: @insurance.name, number: @insurance.number, phone: @insurance.phone, user_id: @insurance.user_id } }
