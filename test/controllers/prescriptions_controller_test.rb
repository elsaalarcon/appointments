...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { comments: @prescription.comments, name: @prescription.name, notes_id: @prescription.notes_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { comments: @prescription.comments, name: @prescription.name, notes_id: @prescription.notes_id } }
